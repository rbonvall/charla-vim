...
\begin{frame}
    %\only<1>{\includegraphics[width=\textwidth]{capturas/html-01-nq8}}
    %\only<2>{\includegraphics[width=\textwidth]{capturas/html-02-nq8}}
    %\only<3>{\includegraphics[width=\textwidth]{capturas/html-03-nq8}}
    %\only<4>{\includegraphics[width=\textwidth]{capturas/html-04-nq8}}
    %\only<5>{\includegraphics[width=\textwidth]{capturas/html-05-nq8}}
    %\only<6>{\includegraphics[width=\textwidth]{capturas/html-06-nq8}}
    %\only<7>{\includegraphics[width=\textwidth]{capturas/html-07-nq8}}
    %\only<8>{\includegraphics[width=\textwidth]{capturas/html-08-nq8}}
    %\only<9>{\includegraphics[width=\textwidth]{capturas/html-09-nq8}}
    %\only<10>{\includegraphics[width=\textwidth]{capturas/html-10-nq8}}
    %\only<11>{\includegraphics[width=\textwidth]{capturas/html-11-nq8}}
    %\only<12>{\includegraphics[width=\textwidth]{capturas/html-12-nq8}}
    %\only<13>{\includegraphics[width=\textwidth]{capturas/html-13-nq8}}
    %\only<14>{\includegraphics[width=\textwidth]{capturas/html-14-nq8}}
    %\only<15>{\includegraphics[width=\textwidth]{capturas/html-15-nq8}}
    %\only<16>{\includegraphics[width=\textwidth]{capturas/html-16-nq8}}
    %\only<17>{\includegraphics[width=\textwidth]{capturas/html-17-nq8}}
    %\only<18>{\includegraphics[width=\textwidth]{capturas/html-18-nq8}}
    %\only<19>{\includegraphics[width=\textwidth]{capturas/html-19-nq8}}
    %\only<20>{\includegraphics[width=\textwidth]{capturas/html-20-nq8}}
    %\only<21>{\includegraphics[width=\textwidth]{capturas/html-21-nq8}}
    %\only<22>{\includegraphics[width=\textwidth]{capturas/html-22-nq8}}
    %\only<23>{\includegraphics[width=\textwidth]{capturas/html-23-nq8}}
    %\\
    \uncover<2->{\key{o}}%
